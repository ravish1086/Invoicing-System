...
<%
int partyid=new PartyInterfaceImplementation().generateId();
%>
...
<td><a href="editparty.jsp?partyid=<%=list2.getPartyId()%>">edit</a></td><td><a href="deleteparty?partyid=<%=list2.getPartyId()%>">/delete</a></td>
</tr>
<%
}
}
