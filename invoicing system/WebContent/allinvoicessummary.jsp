...
<br>
<br><br>
<form action="allinvoicessummary.jsp">
...
<%
List<InvoiceBasicInfo> invoicelist= new InvoiceInterfaceImplementation().getallInvoiceInfo(date1,date2);
...
<td><a href="viewinvoice.jsp?invno=<%=list.getInvoiceNO()%>">View Invoice</a></td>
</tr>
<%
}
}
