...
<tr ><td style="border:1px solid black;" >S.No.</td><td style="border:1px solid black; width:45%;">ProductName</td><td style="border:1px solid black;">Hsn</td><td style="border:1px solid black;">TaxRate</td><td style="border:1px solid black;">PurchasePrice</td><td style="border:1px solid black;">Quantity</td><td style="border:1px solid black;">IUom</td><td style="border:1px solid black;">TaxableAmount</td><td style="border:1px solid black;">CGST Amount</td><td style="border:1px solid black;">SGST Amount</td><td style="border:1px solid black;">NetAmount</td></tr>
<%
int i;
for(i=1;i<16;i++)
{
...
%>
<tr><td style="border-right:1px solid black; border-left:1px solid black;"><%=i %></td><td style="border-right:1px solid black;"><%=item %></td><td style="border-right:1px solid black;"><%=request.getParameter("itemhsn"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("itemtaxrate"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("itempurchaseprice"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("qty"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("itemuom"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("amount"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("cgsttaxamt"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("sgsttaxamt"+i)%></td><td style="border-right:1px solid black;"><%=request.getParameter("amtaftrtax"+i)%></td></tr>
<%
