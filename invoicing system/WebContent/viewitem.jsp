...
String itemunitprice=new String();
...
itemunitprice="itemunitprice"+no;
qty="qty"+no;
itemuom="itemuom"+no;
...
<td><input style="width:150px;" id="'price'+<%=no %>" type="text" name="<%= itemunitprice%>" value="<%=item.getItemUnitPrice()%>"></td>
<td><input style="width:70px;" type="text" name="<%=qty%>" id="'qty'+<%=no %>" onkeyup="calculate1(this.value,<%=no%>,<%=item.getItemUnitPrice()%>,<%=item.getItemTaxRate()%>)"></td>
