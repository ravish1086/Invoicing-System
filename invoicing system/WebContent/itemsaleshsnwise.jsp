<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.first.DAO.ItemSaleInfoContr" %>
...
<form action="itemsaleshsnwise.jsp">
...
<table class="table">
<tr><td></td><td></td><td></td><td></td><td></td><td>Sum net Amount</td><td><%=new ItemSaleInfoContr().getsuminvoice(date1,date2) %></td></tr>
...
try{
	...
	ps=con.prepareStatement("select hsn,sum(quantity),sum(taxamount),sum(taxablevalue),sum(netamount) from itemsalereport where dated between to_date(?,'yyyy-mm-dd') And to_date(?,'yyyy-mm-dd') group by hsn");
