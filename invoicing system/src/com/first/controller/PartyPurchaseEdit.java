...
import com.first.DAO.PartyInterfaceImplementationPurchase;
import com.first.bean.Party;

/**
 * Servlet implementation class PartyEdit
 */
public class PartyPurchaseEdit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PartyPurchaseEdit() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean b=false;
		try {
			b = new PartyInterfaceImplementationPurchase().updateParty(party);
